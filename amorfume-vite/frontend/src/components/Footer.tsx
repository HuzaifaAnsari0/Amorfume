        ...
        <div className="mx-auto max-w-7xl px-6 pb-10 pt-16">
            <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                <div className="space-y-4">
                    <div>
                        <a href="/">
                            <div className="flex items-center space-x-2 text-2xl font-medium">
                                <span>
                                    <img src="" alt="Amorfume Logo"
                                        width="64" height="64" className="w-24" />
                                </span>
                    ...
                    <div className="max-w-md pr-16 text-md text-gray-200">  Explore a world of captivating perfumes with AI-powered recommendations tailored to your unique preferences.
                    </div>
                    ...
                    <div className="md:grid md:grid-cols-2 md:gap-8">
                        <div>
                            ...
                            <ul role="list" className="mt-6 space-y-4">
                                <li>
                                    <a href="/"
                                        className="text-md leading-6 text-gray-300 hover:text-gray-50">AI Recommendations
                                    </a>
                                </li>
                                <li>
                                    <a href="/"
                                        className="text-md leading-6 text-gray-300 hover:text-gray-50">AI Quiz
                                    </a>
                                </li>
                                <li>
                        ...
                        <div className="mt-10 md:mt-0">
                            <h3 className="text-md font-semibold leading-6 text-white">Company Pages</h3>
                            <ul role="list" className="mt-6 space-y-4">
                                <li>
                                    <a href="/about"
                                ...
                                <li>
                                    <a href="/Store"
                                        className="text-md leading-6 text-gray-300 hover:text-gray-50">Store
                                    </a>
                                </li>
                            </ul>
                        </div>
