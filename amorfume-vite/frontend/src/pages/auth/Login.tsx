...
const Login = () => {
    ...
    return (
<div className="py-4 md:py-8 dark:bg-gray-800 flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 xl:px-20">
    <form onSubmit={handleLogin} className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:max-w-lg xl:p-8 dark:bg-gray-800 dark:border-gray-700 p-6 space-y-4 md:space-y-6 sm:p-8">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-center">Enter details to Login in your account</p>
        ...
        <button type="submit" className="text-white bg-teal-600 hover:bg-teal-700 focus:ring-4 focus:outline-none focus:ring-teal-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-teal-600 dark:hover:bg-teal-700 dark:focus:ring-teal-800">Login</button>
